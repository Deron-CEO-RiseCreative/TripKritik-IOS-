...
static NSString * const kConsumerKey       = @"bVefYo8SzKS6kykyEISZGA";
static NSString * const kConsumerSecret    = @"gT7aHMAv6k__g2Boyv_hHjXCQiI";
static NSString * const kToken             = @"zLakRKKQtyPGP5iNjxiCFnGn2Sp1gpx3";
static NSString * const kTokenSecret       = @"R5ZqPhjN4lsj4eUqhSwJv__0W_8";
